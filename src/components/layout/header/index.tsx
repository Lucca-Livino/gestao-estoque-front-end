...
export default function Header() {
  return (
    <header className="h-18 flex p-4 bg-linear-to-r from-blue-600 to-blue-500 transition-opacity ease-in-out duration-initial backdrop-opacity-95 text-white">

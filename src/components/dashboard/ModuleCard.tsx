...
export default function ModuleCard({ card }: ModuleCardProps) {
  ...
  const cardContent = (
    <div className="bg-blue-500 backdrop-blur-sm rounded-xl p-12 text-white hover:bg-blue-600 transition-colors cursor-pointer min-h-[180px] flex items-center">
